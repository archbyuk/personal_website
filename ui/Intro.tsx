...
export default function Intro() {
  ...
  const introParagraphs = [
    `24년 7월부터 시작해 현재까지 다양한 프로젝트를 경험하며, 프론트엔드와 백엔드는 물론 시스템 구조와 데이터 흐름까지 고민하는 개발자로 성장해왔습니다. 그 동안의 개인 프로젝트, 스타트업, 외주를 넘나들며 서비스를 기획하고 설계하며, 개발과 운영까지 직접 주도해본 경험이 있습니다.`,
